...
func _draw() -> void:
	...
	# Top
	draw_rect(Rect2(rect.position - Vector2(border_size, border_size), Vector2(rect.size.x + border_size * 2, border_size)), col)
	# Bottom
	draw_rect(Rect2(rect.position + Vector2(-border_size, rect.size.y), Vector2(rect.size.x + border_size * 2, border_size)), col)
	# Right
	draw_rect(Rect2(rect.position + Vector2(rect.size.x + border_size, - border_size), Vector2(border_size, rect.size.y + border_size * 2)), col)
